...
button_dlt = Button(root, text="←", padx=40, pady=20, command=button_dlt)

# Graphic: Put the button on the screen
...
button_dlt.grid(row=4, column=2)
